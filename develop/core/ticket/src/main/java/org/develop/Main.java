...
import org.develop.Adapter.SaveTicketToDatabase;
import org.develop.Domain.NewTicket;
import org.develop.Domain.Payment;
import org.develop.Domain.User;
import org.develop.Service.TicketInputHandler;
import org.develop.Service.TicketService;
...
// Dette flyttes eventuelt til database-delen eller main:
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            TicketInputHandler ticketInput = new TicketInputHandler();
            int userId = 1;
            ...
            if (payment.getStatus() == true) {
                if (existingUser != null) {
                    try (Scanner scanner = new Scanner(System.in)) {
                        ...
                        int durationChoice = ticketInput.ticketDurationChoice(scanner);
                        int regionChoice = ticketInput.ticketRegionChoice(scanner);
